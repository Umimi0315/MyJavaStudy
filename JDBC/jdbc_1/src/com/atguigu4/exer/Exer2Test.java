...
public class Exer2Test {
	...
	public void testInsert() {
		...
		System.err.println("四级/六级：");
		int type = scanner.nextInt();
		System.err.println("身份证号");
		String IDCard = scanner.next();
		System.err.println("准考证号：");
		String examCard = scanner.next();
		System.err.println("学生姓名：");
		String studentName = scanner.next();
		System.err.println("所在城市：");
		String location = scanner.next();
		System.err.println("考试成绩：");
...
//				return ps.execute();
		...
		public void testDeleteByExamCard() {
			...
			String examCard=scanner.next();
			//查询指定准考证号的学生
			String sql="select ExamCard examCard,StudentName name,Location location,Grade grade from examstudent where examCard=?";
			Student student = getInstance(Student.class, sql, examCard);
			if (student==null) {
