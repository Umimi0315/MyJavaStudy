...
public class TestDocumentCRUD {
    ...
    public void testCreateOptionId(){
        ...
        Book book = new Book("1", "我们2020的故事", 23, new Date(), "我们在疫情下努力学习！", "北京");
        //转为json
        String json= JSONObject.toJSONString(book);
        //索引一条文档
        IndexResponse indexResponse = transportClient.prepareIndex("dangdang", "book", "1").setSource(json, XContentType.JSON).get();
    ...
    public void testCreateAutoId(){
        //name age bir content address
        Book book = new Book(null, "我们2020的故事-1", 23, new Date(), "我们在疫情下努力学习！,好好听课", "北京");
        //转为json
        String json= JSONObject.toJSONString(book);
        //索引一条文档
    ...
    public void testUpdate(){
        Book book = new Book();
        book.setName("我们2020马上要结束框架学习");
        book.setContent("我们即将结束框架学习，我们非常不舍");
    ...
    public void testDelete(){
        DeleteResponse deleteResponse = transportClient.prepareDelete("dangdang", "book", "vZePtHYByiEKMaLvzQ-f").get();
    ...
    public void testBulk(){
        ...
        //删除
        DeleteRequest deleteRequest = new DeleteRequest("ems", "emp", "e-s2uHYBc3z1GIACxBSM");
        //修改
        Emp emp1 = new Emp();
        emp1.setContent("Spring 框架是一个分层架构，由 7 个定义良好的模块组成。这是一个开源框架，他非常不错！使用真的很方便！");
        UpdateRequest updateRequest = new UpdateRequest("ems", "emp", "eus2uHYBc3z1GIACxBSM").doc(JSONObject.toJSONString(emp1), XContentType.JSON);
